...
The main challenge was achieving acceptable accuracy while keeping FNR low. This was
addressed by introducing asymmetric misclassification costs (`class_weight 1:2`) and
tuning the decision threshold on the validation set. The trade-off is an increase in
